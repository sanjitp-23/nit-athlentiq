...
public final class CameraXViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<List<TrackedPerson>> detectedPersonsLiveData = new MutableLiveData<>(
            new ArrayList<>());

    public MutableLiveData<List<TrackedPerson>> getDetectedPersonsLiveData() {
    ...
    /**
     * Create an instance which interacts with the camera service via the given
     * application context.
     */
